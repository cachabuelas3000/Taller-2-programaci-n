...
public class PatientRepository {
    ...
    // CORRECCIÓN: faltaba este método — sin él los pacientes nunca se guardaban
    public boolean save(Patient patient) {
        String idKey = generateIdKey(patient.getIdentificationType(), patient.getIdPatient());
        if (patientsById.containsKey(idKey)) return false;
        if (patientsByEmail.containsKey(patient.getEmail())) return false;
        patientsById.put(idKey, patient);
